function dither(image) {
  ...
  function getMetadata (){
    if (selectedPalette == marioBros || selectedPalette == marioBros2){
      paletteData = 'Super Mario Bros'
    }

    else if (selectedPalette == donkeyKong) {
      paletteData = 'Donkey Kong'
    }

    else if (selectedPalette == sonic) {
      paletteData = 'Sonic the Hedgehog'
    }

    else if (selectedPalette == undertale) {
      paletteData = 'Undertale'
    }

    else if (selectedPalette == fbwg) {
      paletteData = 'Forest Temple'
    }

    else if (selectedPalette == threeFootNinja) {
      paletteData = 'Three Foot Ninja'
    }

    else if (selectedPalette == powerPamplona) {
      paletteData = 'Power Pamplona'
    }

    else if (selectedPalette == run || run2) {
      paletteData = 'Run'
    }

    else if (selectedPalette == snake) {
      paletteData = 'Snake'
    }
  }
  ...
  sessionStorage.setItem('gameName', JSON.stringify(paletteData));

  

  // var temp = localStorage.getItem('gameName')
  // console.log(temp)
